...
public class HtmlToPdf {
	...
	public static void main(String args[]) throws IOException {
		...
		createPdf(new URL(remoteUrl), "/Users/mlopez/Desktop/simpleflexwmoutput.pdf");
	}
	
	public static void createPdf(String baseUri, String html, String dest) throws IOException {
		ConverterProperties properties = new ConverterProperties();
	    properties.setBaseUri(baseUri);
	    HtmlConverter.convertToPdf(html, new FileOutputStream(dest));
	}
	
	public static void createPdf(URL url, String dest) throws IOException {
